...
//    OUTPUT_FILE_FORMAT("sphereon-conversion-output-file-format", DataTypeDefinition.TEXT, true),
    ...
    protected ParameterDefinition toParameterDefinition(VisionActionExecuter executer) {
        return toParameterDefinition(executer.getParamDisplayLabel(getParamName()), isMandatory());
    }

    protected ParameterDefinition toParameterDefinition(VisionActionExecuter executer, boolean mandatory) {
