...
public class SphereonBlockchainProofRegister extends SphereonWorkflowAction implements ExecutionListener, TaskListener {

    public SphereonBlockchainProofRegister() {
        setActionName(RegisterFileActionExecuter.NAME);
    }
